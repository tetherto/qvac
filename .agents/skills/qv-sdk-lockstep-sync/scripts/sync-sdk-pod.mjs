 ...
 *   node .agents/skills/qv-sdk-lockstep-sync/scripts/sync-sdk-pod.mjs           # apply
 *   node .agents/skills/qv-sdk-lockstep-sync/scripts/sync-sdk-pod.mjs --dry-run # preview
 *   node .agents/skills/qv-sdk-lockstep-sync/scripts/sync-sdk-pod.mjs --check   # exit 1 if drift
 *
...
if (checkMode) {
  ...
  console.error("\nFix: run `node .agents/skills/qv-sdk-lockstep-sync/scripts/sync-sdk-pod.mjs`");
  process.exit(1);
}

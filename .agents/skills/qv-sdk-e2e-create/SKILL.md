...
Executor placement (from [`packages/sdk/e2e/AGENTS.md`](../../../packages/sdk/e2e/AGENTS.md)):
...
- Executor placement, smoke policy, rebuild flow → `packages/sdk/e2e/AGENTS.md` and

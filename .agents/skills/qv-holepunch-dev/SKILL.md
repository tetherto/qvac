...
- Project-specific gotchas belong in a project-scoped skill (for example, `.agents/skills/qv-registry-autobase-patterns/`) or the nearest scoped `AGENTS.md`, not in this skill.

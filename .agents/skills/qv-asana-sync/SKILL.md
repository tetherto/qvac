...
2. Create a **Personal Access Token** with a clear description, e.g. `Local qvac-pr-skills`.
...
6. Store it in your default shell startup file or export it locally. Coding agents may not inherit the app environment, so the helper falls back to asking your default shell for this variable.

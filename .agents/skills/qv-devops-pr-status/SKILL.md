...
- Dev: `tetherto/qvac-workbench`, `tetherto/qvac-internal`, `tetherto/qvac-test-suite`, `tetherto/qvac-registry-vcpkg`, `tetherto/qvac-fabric-speech.cpp`, `tetherto/qvac-ext-stable-diffusion.cpp`, `tetherto/qvac-fabric-llm.cpp`, `tetherto/qvac-ext-ggml`, `tetherto/qvac-ext-bergamot-translator`, `tetherto/qvac-ext-marian-dev`
...
- Shared library README: [.agents/skills/_lib/pr-skills/README.md](../_lib/pr-skills/README.md)
- Generic PR review skill: [.agents/skills/qv-pr-review/SKILL.md](../qv-pr-review/SKILL.md)
- DevOps-flavored PR review skill: [.agents/skills/qv-devops-pr-review/SKILL.md](../qv-devops-pr-review/SKILL.md)

 ...
 *
 *   node .agents/skills/_lib/sdk/agent-stack-plan.mjs
 *   node .agents/skills/_lib/sdk/agent-stack-plan.mjs --json
 *   node .agents/skills/_lib/sdk/agent-stack-plan.mjs --no-npm
 */

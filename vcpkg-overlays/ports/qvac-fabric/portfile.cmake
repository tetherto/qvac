# TEMPORARY rollout-validation overlay. Builds qvac-fabric from the head of
# qvac-fabric-llm.cpp PR #187 "Disable weight repacking for training loads"
# (https://github.com/tetherto/qvac-fabric-llm.cpp/pull/187) instead of the
# registry-published v9840.0.0 tag, so every fabric consumer in this monorepo is
# built and tested against the proposed fabric change before the tag is cut.
#
# Copied verbatim from tetherto/qvac-registry-vcpkg ports/qvac-fabric @ HEAD
# (the 9840.0.0 port); the ONLY changes are REF and SHA512 below. vcpkg.json
# keeps "version": "9840.0.0" so the consumers' existing `version>=` constraint
# and the cross-consumer lockstep check are unaffected (overlay ports bypass
# version resolution entirely).
#
# Remove this directory and the consumers' "overlay-ports" entries once the
# fabric PR is merged and a real tag is published (see /rollout-phase-b).
vcpkg_from_github(

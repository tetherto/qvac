...
import { handleLoadModelDelegated } from './handlers/load-model-delegated'
import { handleCompletionStreamDelegated } from './handlers/completion-stream-delegated'
import { getModelEntry } from './state/model-registry'
import { handleUnloadModel } from './handlers/unload-model'
import { handleUnloadModelDelegated } from './handlers/unload-model-delegated'
...
import { handleHeartbeatDelegated } from './handlers/heartbeat-delegated'
import { handleCancelDelegated } from './handlers/cancel-delegated'

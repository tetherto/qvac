...
//   npm run fuzz:continuous -- OcrDecodeImageFuzz.RawNeverCrashes
//
...
const DEFAULT_FUZZ_TEST = 'OcrDecodeImageFuzz.EncodedNeverCrashes'
const BINARY_NAME = 'ocr-decode-image-fuzz'

...
const TEST_MODELS = {
  ...
  runMobilePerfCtcCpuTest: [MODELS.ctcQ4, MODELS.ctcQ8],
  runMobilePerfCtcGpuTest: [MODELS.ctcQ4, MODELS.ctcQ8],
  runMobilePerfEouCpuTest: [MODELS.eouQ4, MODELS.eouQ8],
  runMobilePerfEouGpuTest: [MODELS.eouQ4, MODELS.eouQ8],
  runMobilePerfSortformerCpuTest: [MODELS.sortformerQ4, MODELS.sortformerQ8],
  runMobilePerfSortformerGpuTest: [MODELS.sortformerQ4, MODELS.sortformerQ8],
  runMobilePerfTdtCpuTest: [MODELS.tdtQ4, MODELS.tdtQ8],
  runMobilePerfTdtGpuTest: [MODELS.tdtQ4, MODELS.tdtQ8],

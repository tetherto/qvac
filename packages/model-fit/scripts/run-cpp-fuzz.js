...
//   npm run fuzz:continuous -- ModelFitConfigParseFuzz.CanonicalKeyNeverCrashes
//
...
const DEFAULT_FUZZ_TEST = 'ModelFitConfigParseFuzz.ParseIntegerNeverCrashes'
const BINARY_NAME = 'model-fit-config-parse-fuzz'

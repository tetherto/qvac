...
import { type FitLlamaProcessConfig, type FitProcessRequest, type FitProcessResponse, type LlamaLoadKind } from './process';
...
export type FitProcessLlamaFit = (loadKind: LlamaLoadKind, config: FitLlamaProcessConfig) => FitResult;

...
export function parseNpmPackageLock(raw: string, sourceLabel = NPM_LOCKFILE): PackageLockFile {
  let parsed: unknown
  try {
...
export function collectPackagesFromNpmLock(lock: PackageLockFile): LockfilePackage[] {

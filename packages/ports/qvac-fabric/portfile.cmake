# qvac-fabric is OURS — per the fabric-change-rollout process, the source
# change (the ggml-opencl ops DocTR needs on Adreno: HARDSIGMOID, HARDSWISH,
# POOL_2D, CONV_2D_DW, CONV_TRANSPOSE_2D) lives in the fabric repo as reviewed
# source, NOT as a .patch in this port. This shared overlay (packages/ports,
# wired into every fabric consumer via "overlay-ports": ["../ports"]) shadows
# only qvac-fabric and pins the fabric branch commit so addon CI builds the
# real change in isolation — the registry is untouched until CI is green.
#
# REF is the HEAD of fabric branch `temp-8828` (off v8828.1.1). It must be
# pushed to the remote below for CI / other machines to fetch it. Phase B will
# repoint this at the merged commit as a published registry version and remove
# this overlay.
vcpkg_from_git(
  OUT_SOURCE_PATH SOURCE_PATH
  URL https://github.com/tetherto/qvac-fabric-llm.cpp
  REF b2d6abbb570cf0e068281beb1250338d77b62933
)

...
let process
try {
  LlmLlamacpp = require('@qvac/llm-llamacpp')
  process = require('bare-process')
} catch (error) {
  console.log('Running example from local llm-llamacpp repository')
  LlmLlamacpp = require('../index')
...
async function main () {
  ...
  const hdKey = process.env.MODEL_HD_KEY || 'ecca02e737c36ffbf1fa78b026d0851e686967347ec0628b7d969cdd45a6b405'
  ...
  const args = {
    ...
    opts: { stats: true },
    logger: console,
    modelName: process.env.MODEL_NAME || 'Llama-3.2-1B-Instruct-Q4_0-00001-of-00005.gguf'
  }

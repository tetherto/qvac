 ...
 * to it. A counter that reports less than that growth is not describing
 * allocation, and no fit on top of it can be an upper bound: the win32 working
 * set saw roughly half the KV growth, while darwin-arm64's RSS saw all of it.

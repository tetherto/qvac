...
Packages: `qvac-lib-infer-llamacpp-llm`, `embed-llamacpp`, `qvac-lib-infer-onnx-tts`, `qvac-lib-infer-whispercpp`, `qvac-lib-infer-parakeet`, `qvac-lib-infer-nmtcpp`, `decoder-audio`, `ocr-onnx`
...
Packages: `dl-filesystem`, `dl-hyperdrive`, `dl-base`, `infer-base`, `qvac-lib-langdetect-text`, `qvac-cli`

...
class LoadModelSrcRequestLlamacppCompletionModelConfig(GeneratedBaseModel):
    ...
    spec_draft_type_k: Annotated[
        str | None,
        Field(
            alias="spec-draft-type-k",
            description="KV-cache key quantization type for the MTP draft context. Unset selects the addon default.",
        ),
    ] = None
    spec_draft_type_v: Annotated[
        str | None,
        Field(
            alias="spec-draft-type-v",
            description="KV-cache value quantization type for the MTP draft context. Unset selects the addon default.",
        ),
    ] = None

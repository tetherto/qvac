"""Unit tests for qvac.logging_streams (per-model log fan-in, all-logs
subscription, registry lifecycle, load/unload side-effects) and
qvac.profiling (the __profiling wire envelope + profiled_call)."""
...
from qvac.logging_streams import (
    SDK_ALL_LOG_ID,

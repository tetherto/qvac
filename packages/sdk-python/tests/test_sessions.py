"""Unit tests for qvac.sessions: the push-style duplex session model over a
...
from qvac.errors import TextToSpeechStreamFailedError, TranscriptionFailedError
from qvac.sessions import (
    EndOfTurnEvent,
    SegmentEvent,
    TextEvent,
    VadEvent,

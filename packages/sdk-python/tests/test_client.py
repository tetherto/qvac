...
from qvac._generated.sdk_version import SDK_VERSION
...
def test_resolve_command_raises_with_no_inputs(monkeypatch, tmp_path) -> None:
    ...
    monkeypatch.setattr("qvac.client._npm_global_sdk_root", lambda: None)
...
def test_resolve_command_uses_global_npm_when_present(monkeypatch, tmp_path) -> None:
    ...
    monkeypatch.setattr("qvac.client._npm_global_sdk_root", lambda: global_root)

"""Unit tests for qvac.notebook.SyncClient: the blocking facade (called from
...
from qvac.notebook import EmbedFailedError, SyncClient
...
@pytest.mark.skipif(
    ...
    reason=f"no built SDK worker found at {WORKER_PATH!r}",
)

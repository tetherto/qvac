"""Unit tests for qvac.api.load_model's client-side behavior (type
inference, alias normalization, mismatch validation, requestId threading,
progress streaming) and the qvac.model_types helpers -- all against a fake

...
def test_api_module_reexports_the_same_classes():
    # qvac.api re-exports for backward compatibility; identity must hold so
    # except-clauses catch regardless of import path.
    from qvac import api, errors

    assert api.CancelFailedError is errors.CancelFailedError
    assert api.ModelUnloadFailedError is errors.ModelUnloadFailedError

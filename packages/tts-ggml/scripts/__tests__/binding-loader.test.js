...
// this package's own JavaScript entry, which is the TTSGgml class.
function packageEntry() {
  const TTSGgml = function TTSGgml() {}
  TTSGgml.ENGINE_CHATTERBOX = 'chatterbox'
  TTSGgml.resolveBackendsDir = () => ''
  return TTSGgml
}

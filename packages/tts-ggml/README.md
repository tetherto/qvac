...
| `streamChunkTokens`       | number     | 0          | **>0 enables native chunk streaming** (speech tokens per chunk; Supertonic: text tokens) |
...
* native sub-sentence chunk streaming (Chatterbox and Supertonic via
  `streamChunkTokens`),

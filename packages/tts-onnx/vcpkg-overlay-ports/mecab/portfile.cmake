# QVAC overlay-port. The only difference with the upstream port
# (microsoft/vcpkg ports/mecab @ 8c901fe2) is the removal of
# WINDOWS_USE_MSBUILD: that flag forces the "Visual Studio NN YYYY"
# generator, which vcpkg picks from the newest MSVC installed on the
# Windows runner. With MSVC 14.50 (VS 18 / 2026 preview) that resolves
# to "Visual Studio 18 2026", a generator unknown to vcpkg's bundled
# CMake 3.31.x and the build aborts during configure. The default
# Ninja generator handles cl.exe v14.50 without that mismatch.

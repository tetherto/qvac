...
find_library(STABLE_DIFFUSION_LIBRARY NAMES stable-diffusion
    PATHS "${_SD_CPP_PREFIX}/lib" NO_DEFAULT_PATH REQUIRED)
find_path(STABLE_DIFFUSION_INCLUDE_DIR NAMES stable-diffusion.h
    PATHS "${_SD_CPP_PREFIX}/include" NO_DEFAULT_PATH REQUIRED)

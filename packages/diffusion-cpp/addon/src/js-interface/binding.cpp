...
#define V(name, fn)                                                            \
  ...
  V("createWorldInstance", qvac_lib_inference_addon_sd::createWorldInstance)
  ...
  V("activateWorld", qvac_lib_inference_addon_sd::activateWorld)
  ...
  V("assessFit", qvac_lib_inference_addon_sd::assessFit)

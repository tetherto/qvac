...
1. **Title**: `# QVAC NMT Addon v{VERSION} Release Notes`
...
4. **Pull Requests**: At the end, include a "## Pull Requests" section listing all PRs in this release:
   ...
   - [#123](https://github.com/tetherto/qvac-lib-infer-nmtcpp/pull/123) - PR title here
   - [#124](https://github.com/tetherto/qvac-lib-infer-nmtcpp/pull/124) - Another PR title
   ```
...
```markdown
# QVAC NMT Addon v0.4.0 Release Notes
...
- [#467](https://github.com/tetherto/qvac-lib-infer-nmtcpp/pull/467) - QVAC-11154: Fix mobile E2E tests workflow_dispatch
- [#470](https://github.com/tetherto/qvac-lib-infer-nmtcpp/pull/470) - feat: automate GitHub releases with mandatory release notes
```

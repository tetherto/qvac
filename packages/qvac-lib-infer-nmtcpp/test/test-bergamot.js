...
console.log('[TEST] Loaded HyperdriveDL')

const TranslationNmtcpp = require('../index')
console.log('[TEST] Loaded TranslationNmtcpp')
...
async function main () {
  ...
  const hdDL = new HyperdriveDL({
    // The hyperdrive key for en-fr translation model weights and config (uncompressed)
    key: 'hd://d8f42ce0bc4b01b11720186b0b1ebc6ff0680ee698a1d880dfe9cee73216e861'
  })
  console.log('[TEST] Created HyperdriveDL')

  const args = {
    loader: hdDL,
    params: { mode: 'full', dstLang: 'fr', srcLang: 'en' },
    diskPath: '../models',
    modelName: 'model.enfr.intgemm.alphas.bin'
  }
  const config = {
    srcVocabName: 'vocab.enfr.spm',
    dstVocabName: 'vocab.enfr.spm',

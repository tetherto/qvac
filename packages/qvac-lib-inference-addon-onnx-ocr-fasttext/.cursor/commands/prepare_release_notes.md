...
4. **Do not include uncommitted changes or untracked files**: If any uncommitted/untracked files are present, ignore them, but warn the user.
...
1. **Title**: `# QVAC OCR Addon v{VERSION} Release Notes`

2. **Introduction**: Write a brief 2-3 sentence summary of what this release brings

3. **Sections**: Create each section using narrative prose style:
...
4. **Pull Requests**: At the end, include a "## Pull Requests" section listing all PRs in this release:
   ...
   - [#123](https://github.com/tetherto/qvac-lib-inference-addon-onnx-ocr-fasttext/pull/123) - PR title here
   - [#124](https://github.com/tetherto/qvac-lib-inference-addon-onnx-ocr-fasttext/pull/124) - Another PR title
   ```
...
- [#67](https://github.com/tetherto/qvac-lib-inference-addon-onnx-ocr-fasttext/pull/67) - Fix mobile E2E tests workflow_dispatch
- [#70](https://github.com/tetherto/qvac-lib-inference-addon-onnx-ocr-fasttext/pull/70) - feat: automate GitHub releases with mandatory release notes
```

...
## Managed mode requires @qvac/cli 0.9

Release metadata for 0.4.0 narrows the optional managed-mode CLI peer to `^0.9.0` so installs resolve the CLI 0.9 / SDK 0.16 runtime. Older CLI minors are no longer accepted.

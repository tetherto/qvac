...
public:
  ...
  ChatterboxConfig missingConditionalDecoderConfig_ {
    ...
    dummyPath_,
    dummyPath_,
    "nonexistent_conditional_decoder.onnx",  // conditionalDecoderPath (doesn't exist)
    dummyPath_
  };

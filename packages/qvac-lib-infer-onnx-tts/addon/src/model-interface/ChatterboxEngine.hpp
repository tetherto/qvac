...
public:
  ...
  explicit ChatterboxEngine(
      const ChatterboxConfig& cfg, SessionFactory factory = nullptr);
...
protected:
  ...
  std::vector<int64_t> assembleSpeechTokenSequence(
...
private:
  ...
  TensorData<float> extractEmbeddings(

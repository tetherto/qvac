...
//   npm run fuzz:continuous -- EmbedConfigParseFuzz.PreferredDeviceNeverCrashes
//
...
const DEFAULT_FUZZ_TEST = 'EmbedConfigParseFuzz.ParseMainGpuNeverCrashes'
const BINARY_NAME = 'embed-config-parse-fuzz'

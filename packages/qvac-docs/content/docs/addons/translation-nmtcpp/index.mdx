...
[Bare module](https://bare.pears.com) that adds support for translation in QVAC using either [Marian](https://marian-nmt.github.io) or [Bergamot](https://browser.mt) as the inference engine.
...
```bash
npm install @qvac/translation-nmtcpp
```
...
```bash
npm install @qvac/translation-nmtcpp @qvac/dl-hyperdrive
```
</Step>

...
Recommended models:
- ASR model families: Whisper
- Supporting models: Silero VAD for voice activity detection
...
```bash
npm install corestore @qvac/dl-hyperdrive @qvac/transcription-whispercpp bare-fs bare-process
```
</Step>
...
- [Source code at GitHub](https://github.com/tetherto)

...
import { Compass, Telescope, Toolbox, Rocket, BookA, LayoutGrid, FolderTree, Blocks, MessageCircleQuestionMark } from 'lucide-react'
...
<Cards>
  ...
  <Card href="/sdk/install-and-quickstart" icon={<Rocket className="text-[var(--color-fd-primary)]" />} title="Install and quickstart">
...
Other resources:
- [Main website](https://qvac.tether.dev)
- [Landing page](https://qvac.tether.io) 
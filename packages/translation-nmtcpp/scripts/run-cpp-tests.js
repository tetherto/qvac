...
// .github/workflows/reusable-cpp-tests-translation-nmtcpp.yml. See
// addon/tests/CMakeLists.txt for the full rationale.
...
function main() {
  ...
  const cwd = path.resolve(__dirname, '..', buildDir, 'addon', 'tests')

...
public:
  ...
  /// Admit the untagged job. The single slot cannot correlate outputs to a
  /// tagged request, so an accepted job is identified as kNoJobId.

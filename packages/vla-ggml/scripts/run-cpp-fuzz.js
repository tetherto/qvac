...
//   npm run fuzz:continuous -- SafetensorsLiteFuzz.HeaderNeverCrashes
//
...
const DEFAULT_FUZZ_TEST = 'SafetensorsLiteFuzz.HeaderNeverCrashes'
const BINARY_NAME = 'safetensors-lite-fuzz'

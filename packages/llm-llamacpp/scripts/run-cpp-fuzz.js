...
//   npm run fuzz:continuous -- LlmStringFuzz.MatchesAnyStopNeverCrashes
//
...
const DEFAULT_FUZZ_TEST = 'LlmStringFuzz.ForLogMessageNeverCrashes'
const BINARY_NAME = 'llm-string-fuzz'

...
// URLs + integrity, and the .github/actions/cache-models cache key). It is
// distinct from scripts/generate-model-manifest.js, which builds the Android
// mobile prestage manifest (test/mobile/model-manifest.json).
//

# TEMPORARY OVERLAY — QVAC-23195 pre-publication verification.
#
# Pinned to the fix branch of qvac-fabric-llm.cpp so the Android addon is built
# against the Adreno nibble-packing fix before it is tagged and published to the
# registry (tetherto/qvac-fabric-llm.cpp#208). vcpkg_from_git takes a full commit
# SHA and needs no tarball hash, which keeps this pin honest.
#
# DELETE THIS OVERLAY once qvac-fabric is published and the version>= in
# ../../vcpkg.json is bumped; the registry port is then authoritative again.
vcpkg_from_git(
  OUT_SOURCE_PATH SOURCE_PATH
  URL https://github.com/tetherto/qvac-fabric-llm.cpp.git
  REF 480ccee84fbac1d0eaf1f7de552eaf0cc6ea0c54
)

...
The `qvac` package provides the command-line interface for the QVAC ecosystem. [API Reference](https://www.npmjs.com/package/@qvac/qvac-cli).

- Provides `npx qvac` for quick access to QVAC tooling without global installation.
- Bundles [`@qvac/qvac-cli`](https://www.npmjs.com/package/@qvac/qvac-cli), the full CLI implementation with all commands.
...
See [@qvac/qvac-cli](https://www.npmjs.com/package/@qvac/qvac-cli) for full command reference and configuration options.

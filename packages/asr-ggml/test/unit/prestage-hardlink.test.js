...
// Both pickup paths (Whisper and Parakeet) share _link-or-copy.js, which stays
// free of the native addon so this suite can load it without a prebuild.

const test = require('brittle')
const fs = require('bare-fs')
const os = require('bare-os')
const path = require('bare-path')
const { linkOrCopySync } = require('../integration/_link-or-copy.js')
...
// The unit suite must never pull the native addon in through a helper import —
// that is what broke sanity-checks (asr-ggml) when this file imported
// parakeet-helpers.js, which requires binding.js at module scope.

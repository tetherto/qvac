...
import { parakeetPlugin } from '@/server/bare/plugins/parakeet-transcription/plugin'
import { whisperPlugin } from '@/server/bare/plugins/whispercpp-transcription/plugin'
import {
  ModelType,

...
import { vlaPreprocessImage, vlaPadState, VLA_DEFAULT_IMAGE_SIZE } from '@/client/api/vla-helpers'
...
import { vlaSetEmbodiment } from '@/server/bare/plugins/ggml-vla/ops/vla-set-embodiment'

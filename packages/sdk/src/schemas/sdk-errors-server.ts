...
const serverErrorDefinitions: ErrorCodesMap = {
  ...
  // Vector index (52,850-52,899)
  [SDK_SERVER_ERROR_CODES.VECTOR_INDEX_PROVIDER_UNAVAILABLE]: {
  ...
  [SDK_SERVER_ERROR_CODES.VECTOR_INDEX_NOT_FOUND]: {
  ...
  [SDK_SERVER_ERROR_CODES.VECTOR_INDEX_INVALID_VECTORS]: {
    name: 'VECTOR_INDEX_INVALID_VECTORS',
    message: (details: string) => `Invalid vector input: ${details}`
  },
  [SDK_SERVER_ERROR_CODES.VECTOR_INDEX_FAILED]: {

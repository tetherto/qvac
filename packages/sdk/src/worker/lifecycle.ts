...
import {
  initialize as initializeEngine,
  close as closeEngine,
  cleanupForTerminate as cleanupEngineForTerminate
...
export function initializeWorker(): { hasRPCConfig: boolean } {
...
export async function cleanupForTerminate(): Promise<void> {
  await cleanupEngineForTerminate()
}

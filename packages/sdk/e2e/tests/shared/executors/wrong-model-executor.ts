...
import { wrongModelTests, wrongModelTranscribeOnLlm } from '../../wrong-model-tests.js'

export class WrongModelExecutor extends AbstractModelExecutor<typeof wrongModelTests> {
  pattern = /^wrong-model-/
  ...
  async transcribeOnLlm(_params: unknown, expectation: unknown): Promise<TestResult> {

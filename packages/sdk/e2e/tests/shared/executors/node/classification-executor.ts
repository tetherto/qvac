...
const SAMPLE_IMAGE_PATH = path.resolve(process.cwd(), 'assets/images/elephant.jpg')

export class ClassificationExecutor extends AbstractModelExecutor<typeof classificationTests> {

...
export const delegatedInvalidProviderKey = createDelegatedTest(
  'delegated-invalid-provider-key',
  {},
  { validation: 'throws-error', errorContains: '' },
  5000
)
...
export const delegatedE2ECompletion = createDelegatedTest(
  ...
  180000,
  {
    reason: 'E2E delegation requires child_process (Desktop only)',

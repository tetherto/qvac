...
export const executor = createExecutor({
  handlers: [
    ...
    new SkipExecutor(/^video-/, "Video generation tests are desktop-only (Wan video model loading and AVI file assertions rely on Node fs and exceed mobile device budgets)"),

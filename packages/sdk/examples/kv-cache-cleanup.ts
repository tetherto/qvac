...
try {
  ...
  console.log('\n▸ 3. Reclaim automatic caches only (named keys survive):')
  console.log('▸    await deleteCache({ auto: true })')
  console.log('▸    └─ Removes: every kvCache:true cache no request is using')
  console.log('\n▸ 4. Delete ALL caches (entire cache folder):')
  ...
  console.log('▸    - Disk space cleanup → Reclaim with { auto: true }')

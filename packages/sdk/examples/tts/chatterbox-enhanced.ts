import {
  ...
  TTS_LAVASR_ENHANCER_BACKBONE_FP32,
  TTS_LAVASR_ENHANCER_SPEC_HEAD_FP32,
  TTS_LAVASR_DENOISER,
} from "@qvac/sdk";
import {
  createWav,
  ...
  const enhancedModelId = await loadModel({
    ...
    modelConfig: {
      ...
      enhancer: {
        ...
        enhance: true,
        denoise: true,
        backboneSrc: TTS_LAVASR_ENHANCER_BACKBONE_FP32.src,
        specHeadSrc: TTS_LAVASR_ENHANCER_SPEC_HEAD_FP32.src,
        denoiserSrc: TTS_LAVASR_DENOISER.src,
      },
    },
    onProgress,
  });

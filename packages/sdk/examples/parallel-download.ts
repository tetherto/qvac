...
try {
  ...
  for (let i = 0; i < assets.length; i++) {
    ...
    const timeToFirst =
      t.firstProgress !== undefined ? `${((t.firstProgress - t.start) / 1000).toFixed(1)}s` : 'N/A'

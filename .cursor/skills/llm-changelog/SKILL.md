---
name: llm-changelog
description: Generate changelog entries for the LLM add-on. Use when preparing a new release.
---
...
Create or update the matching version section in `CHANGELOG.md` for `qvac-lib-infer-llamacpp-llm` with these guidelines:

...
Nearly every page closes the section with a pointer to the model constants. The wording has four variants and they are not interchangeable. Match the page you are editing.

| Occurrences | Wording |
| --- | --- |
| 12 | `For models available as constants, see [SDK — Models](/introduction#models).` |
| 2 | `For model artifacts available as constants, see [SDK — Models](/introduction#models).` |
| 1 | `For model constants, see [SDK — Models](/introduction#models).` |

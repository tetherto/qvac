...
| **Music generation** | Generate music from text, lyrics, and musical controls with [`@qvac/audiogen-ggml`](packages/audiogen-ggml/README.md), backed by [ACE-Step](https://github.com/ace-step/ACE-Step-1.5) or [MiniMax-Music3](https://huggingface.co/MiniMaxAI/MiniMax-Music3). ACE-Step prebuilds cover Linux, macOS, Windows, Android arm64, and iOS arm64. MiniMax is desktop CPU-only and requires an application-provided local GGUF pair. |

---
title: "@qvac/sdk v0.20"
description: "The @qvac/sdk README as released in sdk-v0.20.0."
---

*The `@qvac/sdk` README as released in [`sdk-v0.20.0`](https://github.com/tetherto/qvac/releases/tag/sdk-v0.20.0). Every documented version is listed on the [`@qvac/sdk` index](/ecosystem/inventory/sdk).*
...
> **In-process Bare:** use [`@qvac/inference`](https://github.com/tetherto/qvac/blob/sdk-v0.20.0/packages/inference/README.md). `@qvac/bare-sdk` is deprecated; last release is 0.18.2.
...
See the [system resources support matrix](https://github.com/tetherto/qvac/blob/sdk-v0.20.0/packages/sdk/docs/system-resources-support-matrix.md)
...
See [pre-download model fit assessment](https://github.com/tetherto/qvac/blob/sdk-v0.20.0/packages/sdk/docs/assess-model-fit.md) for the
...
[ABot-World interactive world sessions](https://github.com/tetherto/qvac/blob/sdk-v0.20.0/packages/sdk/docs/abot-world.md).
...
| Client (consumer) | Node / RN  | `e2e/`   | See [`e2e/README.md`](https://github.com/tetherto/qvac/blob/sdk-v0.20.0/packages/sdk/e2e/README.md) |

See [`TESTING.md`](https://github.com/tetherto/qvac/blob/sdk-v0.20.0/packages/sdk/TESTING.md) for the full decision tree on where new tests should land.

...
*The `@qvac/sdk` README as released in [`sdk-v0.18.2`](https://github.com/tetherto/qvac/releases/tag/sdk-v0.18.2). Every documented version is listed on the [`@qvac/sdk` index](/ecosystem/inventory/sdk).*

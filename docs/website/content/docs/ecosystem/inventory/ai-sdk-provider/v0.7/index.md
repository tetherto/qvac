---
title: "@qvac/ai-sdk-provider v0.7"
description: "The @qvac/ai-sdk-provider README as released in ai-sdk-provider-v0.7.0."
---

*The `@qvac/ai-sdk-provider` README as released in [`ai-sdk-provider-v0.7.0`](https://github.com/tetherto/qvac/releases/tag/ai-sdk-provider-v0.7.0). Every documented version is listed on the [`@qvac/ai-sdk-provider` index](/ecosystem/inventory/ai-sdk-provider).*

---
title: "@qvac/cli v0.12"
description: "The @qvac/cli README as released in cli-v0.12.0."
---

*The `@qvac/cli` README as released in [`cli-v0.12.0`](https://github.com/tetherto/qvac/releases/tag/cli-v0.12.0). Every documented version is listed on the [`@qvac/cli` index](/ecosystem/inventory/cli).*

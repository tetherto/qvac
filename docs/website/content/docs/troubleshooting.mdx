...
Omit `sudo` when running as root inside a container. Restart the application after installing the library. See [system requirements](/system-requirements#linux) and [issue #4290](https://github.com/tetherto/qvac/issues/4290).

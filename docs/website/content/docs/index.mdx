...
import { MessagesSquare, Hash, Languages, Mic, Music, Speech, Volume2, ScanText, Image as ImageIcon, Video, Waypoints, GalleryHorizontal, FlaskConical, ScanSearch, Shapes, Eye, Brain, DoorOpen, Server, MonitorPlay } from 'lucide-react'
...
<Cards className="grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
  ...
  <Card href="/ai-capabilities/world-simulation" title={<span className="inline-flex items-center gap-2"><Waypoints className="size-4 text-[var(--color-fd-primary)]" />World simulation</span>}>

...
import { Sparkles, Telescope, Compass, Rocket, BookA, LayoutGrid, FolderTree, Blocks, MessageCircleQuestionMark, Wrench } from 'lucide-react'
...
<Cards>
  <Card href="/about-qvac/welcome" icon={<Sparkles className="text-[var(--color-fd-primary)]" />} title="Welcome">
    Learn what QVAC is, why Tether built it, and what makes it different.
  </Card>
  <Card href="/about-qvac/welcome" icon={<Telescope className="text-[var(--color-fd-primary)]" />} title="Our vision">
...
<Cards>
  <Card href="/getting-started" icon={<Compass className="text-[var(--color-fd-primary)]" />} title="Get started with QVAC SDK">
    Use the JS/TS SDK to build local and P2P AI applications and systems.
  </Card>
  <Card href="/getting-started/quickstart" icon={<Rocket className="text-[var(--color-fd-primary)]" />} title="Quickstart">
    Run your first example using the JS/TS SDK.
  </Card>
  <Card href="/getting-started/installation" icon={<Wrench className="text-[var(--color-fd-primary)]" />} title="Installation">
    Supported environments and how to install the SDK for each one: Node.js, Bare, and Expo.
  </Card>
  <Card href="/references/api" icon={<BookA className="text-[var(--color-fd-primary)]" />} title="API reference">
...
<Cards>
  <Card href="https://qvac.tether.dev/products/how-tos/" icon={<MessageCircleQuestionMark className="text-[var(--color-fd-primary)]" />} title="SDK FAQ">
  ...
  <Card href="/references/addons" icon={<Blocks className="text-[var(--color-fd-primary)]" />} title="Addons">
...
<Cards>
  <Card href="/tutorials/electron" icon={<SiElectron className="text-[var(--color-fd-primary)]" />} title="Build an Electron app">
    Hands-on tutorial on using QVAC SDK with Electron.
  </Card>
  <Card href="/tutorials/expo" icon={<SiExpo className="text-[var(--color-fd-primary)]" />} title="Build an Expo app">

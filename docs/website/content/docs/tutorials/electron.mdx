...
Now that the app works in development, let's build a distributable using the [`@qvac/sdk/electron-forge`](https://www.npmjs.com/package/@qvac/sdk) plugin, which:
...
<Step>
Install electron-forge and the QVAC plugin's peer dependency:

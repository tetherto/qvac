...
| --- | --- | :---: | --- |
| `modelType` | `string` | ✓ | — |
| `modelSrc` | `string \| \{ src: string; name?: string \| —; modelId?: string \| —; registryPath?: string \| —; registrySource?: string \| —; blobCoreKey?: string \| —; ... 4 more ...; addon?: "llamacpp-completion" \| ... 16 more ... \| —; \}` | ✓ | — |
| `modelConfig` | `Record<string, unknown> \| \{ engine: "Opus"; from: "en" \| "de" \| "es" \| "it" \| "ru" \| "ja"; to: "en" \| "de" \| "es" \| "it" \| "ru" \| "ja"; mode?: "full" \| —; beamsize?: number \| —; ... 6 more ...; topp?: number \| —; \} \| ... 10 more ... \| —` | ✗ | — |
| `seed` | `boolean \| —` | ✗ | — |
| `delegate` | `\{ topic: string; providerPublicKey: string; timeout?: number \| —; healthCheckTimeout?: number \| —; fallbackToLocal?: boolean \| —; forceNewConnection?: boolean \| —; \} \| —` | ✗ | — |
| `onProgress` | `(progress: \{ type: "modelProgress"; downloaded: number; total: number; percentage: number; downloadKey: string; shardInfo?: \{ currentShard: number; totalShards: number; shardName: string; overallDownloaded: number; overallTotal: number; overallPercentage: number; \} \| —; onnxInfo?: \{ ...; \} \| —; \}) =>...` | ✗ | — |
| `logger` | `Logger` | ✗ | — |

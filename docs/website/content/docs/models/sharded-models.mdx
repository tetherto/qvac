...
All numbered shard files **must** be present in the same directory, for example:
...
When using `loadModel()`, you pass the path to any shard (e.g., `model-00003-of-00005.gguf`), and the SDK automatically detects and loads the remaining shards.

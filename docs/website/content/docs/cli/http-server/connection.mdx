...
```json title="opencode.json"
{
  ...
  "provider": {
    "qvac": {
      ...
      "models": {
        "qwen3-8b-chat":  { "name": "Qwen3 8B (chat)",  "limit": { "context": 16384 } },
        "qwen3-8b-title": { "name": "Qwen3 8B (title)", "limit": { "context": 16384 } }
      }
    }
  },

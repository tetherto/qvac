...
The first run may download model files before the answer appears. Use `qwen3.5-9b` or a stronger raw QVAC model constant for real agent work; smaller models can answer simple prompts but are less reliable with tool-heavy agent sessions.

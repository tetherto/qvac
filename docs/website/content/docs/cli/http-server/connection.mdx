...
The plugin uses `qvac/qwen3.5-9b` by default. Use that for the best local OpenCode experience; if your machine cannot keep the 9B model warm comfortably, switch to `qwen3.5-4b`:
...
See the [`@qvac/opencode-plugin` README](https://www.npmjs.com/package/@qvac/opencode-plugin) for the complete plugin model list and advanced options.

...
To create a client, you can use any OpenAI-compatible AI SDK provider, such as [Vercel AI SDK](https://ai-sdk.dev?utm_source=chatgpt.com). For a better developer experience, use our npm package `@qvac/ai-sdk-provider`.

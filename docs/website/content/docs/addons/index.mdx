...
| [`@qvac/transcription-whispercpp`](/addons/transcription-whispercpp) | Transcription | Automatic speech recognition (ASR) for speech-to-text. | [`qvac-fabric-speech.cpp`](https://github.com/tetherto/qvac-fabric-speech.cpp) | stable |
...
| [`@qvac/tts-ggml`](/addons/tts-ggml) | Text-to-speech | Speech synthesis for text-to-speech (TTS). | [`qvac-tts.cpp`](https://github.com/tetherto/qvac-fabric-speech.cpp/tree/master/engines/tts) (GGML) | stable |

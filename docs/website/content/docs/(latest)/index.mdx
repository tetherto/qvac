...
description: Local AI JS/TS SDK, libraries, and tools built for developers who want to launch local-first decentralized P2P AI applications and systems without sacrificing performance, privacy or control. Run AI tasks like LLMs, speech, RAG, and more across Linux, macOS, Windows, Android, and iOS.
---

...
Translation uses your choice of either [`nmt.cpp`](https://github.com/tetherto/translation-nmtcpp) or [Bergamot](https://browser.mt) as inference engine. Load any supported model using `modelType: "nmt"`, and `modelConfig.engine: "Bergamot"` for Bergamot.

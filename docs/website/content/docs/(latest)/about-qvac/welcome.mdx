---
title: Welcome
description: Learn what QVAC is, who its for, why Tether built it, and what makes it different.
---
...
QVAC is built for developers who want to create AI-powered applicationsthat respect user privacy, run without cloud infrastructure, and work seamlessly across desktop and mobile devices. Whether you're building a chatbot, a voice assistant, or embedding AI into an existing application, QVAC gives you the tools to build it without sacrificing performance, privacy, or control.

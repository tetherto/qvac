...
*The `@qvac/cli` README as released in [`cli-v0.13.1`](https://github.com/tetherto/qvac/releases/tag/cli-v0.13.1). Every documented version is listed on the [`@qvac/cli` index](/platform/inventory/cli).*

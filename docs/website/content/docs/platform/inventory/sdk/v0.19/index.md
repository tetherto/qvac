...
*The `@qvac/sdk` README as released in [`sdk-v0.19.1`](https://github.com/tetherto/qvac/releases/tag/sdk-v0.19.1). Every documented version is listed on the [`@qvac/sdk` index](/platform/inventory/sdk).*

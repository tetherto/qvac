...
QVAC SDK is distributed as the npm package `@qvac/sdk` for JavaScript/TypeScript projects. For Python, install `tetherto-qvac-sdk` from PyPI — see the [Python SDK](/python-sdk) guide.

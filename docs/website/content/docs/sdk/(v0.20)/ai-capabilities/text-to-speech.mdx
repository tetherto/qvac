...
[`cancel()`](/sdk/reference/api#cancel) to stop synthesis:
...
| `tokensPerSecond` | Input characters synthesized per second; on Audio8, codec frames per second. |
...
<Callout type="success">
  **Tip:** all examples throughout this documentation are self-contained and
  ...
  quickstart](/sdk/js-ts-sdk#quickstart) or the [Python
  quickstart](/sdk/python-sdk#quickstart).
</Callout>

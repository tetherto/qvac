...
2. [`completion()`](/references/api/completion)
...
- If the model is sharded across multiple files (a multi-file bundle), see [Sharded models](/how-tos/sharded-models).
- For multimodal prompts (images + text), see [Multimodal](/how-tos/multimodal).

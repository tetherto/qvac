...
| --- | --- | --- |
| LLM | `@qvac/sdk/llamacpp-completion/plugin` | [Completion](/how-tos/completion); [multimodal](/how-tos/multimodal); [RAG](/how-tos/rag) |
| Embeddings | `@qvac/sdk/llamacpp-embedding/plugin` | [Text embeddings](/how-tos/text-embeddings); [RAG](/how-tos/rag) |
| ASR | `@qvac/sdk/whispercpp-transcription/plugin` | [Transcription](/how-tos/transcription) |
| NMT | `@qvac/sdk/nmtcpp-translation/plugin` | [Translation](/how-tos/translation) |
| TTS | `@qvac/sdk/onnx-tts/plugin` | [Text-to-Speech](/how-tos/text-to-speech) |
| OCR | `@qvac/sdk/onnx-ocr/plugin` | [OCR](/how-tos/ocr) |
...
<Step>
[In your `qvac.config.*`, add the built-in plugins you’ll need in your project](/getting-started/configuration). For example:
...
[When developing for mobile environment, use the Expo CLI to prebuild your project only with the selected plugins:](/getting-started/installation/#expo)
...
[In your `qvac.config.*`, add its `<package_name>/plugin` specifier alongside any built-in plugins](/getting-started/configuration). For example:
...
<Tab value="mobile" label="Expo">
[When developing for mobile environment, use the Expo CLI to prebuild your project with all listed plugins:](/getting-started/installation/#expo)
...
* [Each plugin maps to one QVAC addon](/references/addons).
* [Write a custom plugin](/how-tos/write-custom-plugin).
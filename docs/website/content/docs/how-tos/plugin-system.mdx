...
[When developing for mobile environment, use the Expo CLI to prebuild your project only with the selected plugins:](/getting-started/install/#expo)
...
<Tab value="mobile" label="Expo">
[When developing for mobile environment, use the Expo CLI to prebuild your project with all listed plugins:](/getting-started/install/#expo)

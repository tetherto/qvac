...
- **Fallback:** the `qv-notice-generate` compliance SKILL
  ([`.agents/skills/qv-notice-generate`](../../.agents/skills/qv-notice-generate/SKILL.md))
...
- **Gate:** [`.github/workflows/workflow-security.yml`](../../.github/workflows/workflow-security.yml).
  ...
  - **Pass 2 — job `workflow-security-agent` (Claude Code):** an
    ...
    [`.agents/skills/qv-devops-pr-review`](../../.agents/skills/qv-devops-pr-review/SKILL.md),

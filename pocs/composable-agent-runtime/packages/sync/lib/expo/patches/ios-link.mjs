/**
 * Manifest-aware ios/link.mjs adaptation for Sync standalone Expo prebuild.
 *
 ...
 *
 * Installed over react-native-bare-kit/ios/link.mjs by Sync standalone finalization.
 */
import fs from 'fs'

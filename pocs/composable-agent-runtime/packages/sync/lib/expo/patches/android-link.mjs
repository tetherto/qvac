/**
 * Manifest-aware android/link.mjs adaptation for Sync standalone Expo prebuild.
 *
 ...
 *
 * Installed over react-native-bare-kit/android/link.mjs by Sync standalone finalization.
 */
import fs from 'fs'

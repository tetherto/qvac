/**
 * Manifest-aware ios/link.mjs adaptation for Harness standalone Expo prebuild.
 *
 ...
 *
 * Installed over react-native-bare-kit/ios/link.mjs by Harness standalone finalization.
 */
import fs from 'fs'

/**
 * Manifest-aware android/link.mjs adaptation for Harness standalone Expo prebuild.
 *
 ...
 *
 * Installed over react-native-bare-kit/android/link.mjs by Harness standalone finalization.
 */
import fs from 'fs'
